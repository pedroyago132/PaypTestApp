...
export default function ExcluirServiço({ navigation, route }) {
    ...
    function excluirServiço() {
        database().ref(`estabelecimento/${base64.encode(user.email)}/itemServ/${infoServiço.key}`)
            .remove()
            .then(() => l())
    ...
    return (
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: 'center' }} >
            <Text>Deseja Excluir esse serviço?</Text>
